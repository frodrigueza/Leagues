...
class LeagueUsersControllerTest < ActionController::TestCase
  ...
  test "should create league_user" do
    assert_difference('LeagueUser.count') do
      post :create, league_user: { league_id: @league_user.league_id, role: @league_user.role, user_id: @league_user.user_id }
    end
  ...
  test "should update league_user" do
    patch :update, id: @league_user, league_user: { league_id: @league_user.league_id, role: @league_user.role, user_id: @league_user.user_id }
    assert_redirected_to league_user_path(assigns(:league_user))
  end
